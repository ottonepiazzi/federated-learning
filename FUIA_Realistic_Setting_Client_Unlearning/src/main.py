...
from config import (SEED, NUM_CLIENTS, FRACTION, NUM_ROUNDS, LOCAL_EPOCHS,
                    BATCH_SIZE, FL_LR, NUM_CLASSES, TARGET_CLIENT, TARGET_SIZE,
                    WEIGHTED_AGGREGATION,
                    INV_ITERATIONS, INV_LR, INV_GAMMA, INV_ALPHA, INV_RESTARTS)
...
if __name__ == "__main__":
    wandb.init(project="FUIA", config={
        ...
        "partition": "iid",
        "pretraining": False,
        "aggregation": "size_weighted" if WEIGHTED_AGGREGATION else "uniform",
